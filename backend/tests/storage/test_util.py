...
def get_test_file_path(app: Flask) -> Path:
    ...
    file_path: Path = storage_path / "testcase" / "test_file"
    return file_path
...
class TestIsFileExists:
    def test_with_exist_file_should_return_true(
        ...
        with app.app_context():
            ...
            assert is_file_exists("test_file", TunnelCode.TESTCASE)

    def test_with_not_exist_file_should_return_false(self, app: Flask):
        with app.app_context():

            assert not is_file_exists("test_file", TunnelCode.TESTCASE)
...
class TestWriteFile:
    def test_write_exists_file_should_write_string_to_file(
        ...
        with app.app_context():
            ...
            write_file("test_file", "some_test_string", TunnelCode.TESTCASE)
    ...
    def test_write_bytes_to_exists_file_should_write_string_to_file(
        ...
        with app.app_context():
            ...
            write_file_bytes("test_file", b"some_test_string", TunnelCode.TESTCASE)
...
class TestReadFile:
    def test_read_string_from_exists_file_should_read_string_from_file(
        ...
        with app.app_context():
            ...
            text: str = read_file("test_file", TunnelCode.TESTCASE)
    ...
    def test_read_bytes_from_exists_file_should_read_bytes_from_file(
        ...
        with app.app_context():
            ...
            file_bytes: bytes = read_file_bytes("test_file", TunnelCode.TESTCASE)
...
class TestDeleteFile:
    def test_delete_exists_file_should_delete_the_test_file(
        ...
        with app.app_context():
            ...
            delete_file("test_file", TunnelCode.TESTCASE)
