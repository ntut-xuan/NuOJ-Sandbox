...
def test_with_test_task_should_change_the_task_status(app: Flask, cleanup_test_sandbox: None, test_task: Task):
...
def test_with_test_task_should_have_running_timestamp(app: Flask, cleanup_test_sandbox: None, test_task: Task):
    with app.app_context():
        initialize_task(test_task, 0)
        initialize_test_case_to_sandbox(test_task.test_case, 0)
...
def test_compile_with_test_task_should_return_result(app: Flask, cleanup_test_sandbox: None, test_task: Task):
    with app.app_context():
...
def test_execute_with_test_task_should_return_result(app: Flask, cleanup_test_sandbox: None, test_task: Task):
    with app.app_context():
...
def test_judge_with_test_task_should_return_result(app: Flask, cleanup_test_sandbox: None, test_task: Task):
    with app.app_context():
        initialize_task(test_task, 0)
        initialize_test_case_to_sandbox(test_task.test_case, 0)
...
def test_with_invalid_execute_type_should_return_error_result(app: Flask, cleanup_test_sandbox: None, test_task: Task):
    with app.app_context():
