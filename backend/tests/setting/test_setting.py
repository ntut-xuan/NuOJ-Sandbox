...
def test_setting_object_should_have_correct_compiler_command_of_submit_code(setting: Setting):
    ...
    assert cpp14_compiler_setting.get_submit_code_compile_command() == "/bin/g++ --std=c++14 submit.cpp -o submit.o"
...
def test_setting_object_should_have_correct_compiler_command_of_solution(setting: Setting):
    ...
    assert cpp14_compiler_setting.get_solution_compile_command() == "/bin/g++ --std=c++14 solution.cpp -o solution.o"
